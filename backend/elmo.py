...
class EventLogManager:
    ...
    def __create_basic_frames(self):
        ocel2 = self.ocel2
        self.event_frame = ocel2.events[:]
        self.e2o_frame = ocel2.relations[["ocel:eid", "ocel:oid", "ocel:qualifier", "ocel:type"]][:]
        self.o2o_frame = ocel2.o2o[:]
        self.object_frame = ocel2.objects[:]
        self.object_change_frame = ocel2.object_changes[:]

    def __create_object_evolution_frame(self):
        object_frame = self.object_frame
        event_frame = self.event_frame
        object_change_frame = self.object_change_frame
        ...
        self.object_evolutions_frame = object_evolutions

    def __create_attribute_enriched_event_frame(self):
        event_frame = self.event_frame
        e2o_frame = self.e2o_frame
        object_evolution_frame = self.object_evolutions_frame
